...
//     version 1.14.2
//     from Assets/Scripts/Player/Game Input.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Player/Game Input.inputactions".
/// </summary>
/// <remarks>
...
public partial class @GameInput: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Controller_Direction = m_Controller.FindAction("Direction", throwIfNotFound: true);
        m_Controller_Dash = m_Controller.FindAction("Dash", throwIfNotFound: true);
    }

    ~@GameInput()
    {
        UnityEngine.Debug.Assert(!m_Controller.enabled, "This will cause a leak and performance issues, GameInput.Controller.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Controller_Direction;
    ...
    public struct ControllerActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Controller/Direction".
        /// </summary>
        public InputAction @Direction => m_Wrapper.m_Controller_Direction;
        /// <summary>
